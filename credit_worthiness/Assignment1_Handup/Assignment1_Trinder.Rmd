...
> RF_sModel$confusion
     Bad Good class.error
Bad   70  143 0.671361502
Good   1  301 0.003311258
```
...
> RF_model$confusion
     Bad Good class.error
Bad  138   75   0.3521127
Good  67  235   0.2218543
```

So we can clearly see that the model has become much better at correctly identifying the good credit standing class. With the cost of misclassificiation being in the ration of 1:5, this would represent a saving of almost 36% to the financial instution however this on on the training data so we expect the test number to be lower.
